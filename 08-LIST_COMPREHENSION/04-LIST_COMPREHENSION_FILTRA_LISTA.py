...
# - O objetivo é identificar quem são os clientes inadimplentes e enviar essa lista de clientes para o setor de
# cobrança poder fazer a cobrança dos clientes. - Queremos então criar uma lista com os clientes inadimplentes (
# apenas o CPF e o valor que eles estão devendo) - A inadimplência nessa empresa é calculada da seguinte forma: 1. Se
# o cliente tiver devendo há mais de 20 dias, ele é considerado inadimplente. 2. As informações vêm no formato (cpf,
# valor_devido, qtde de dias)

cliente_inadiplentes = []
...
lista_devedores_dias = [cpf for cpf, valor, dias in clientes_devedores if dias == 15]
print("Os CPF DOS CLIENTE INADIPLENTES SAO {}".format(lista_devedores_dias))
