...
# - Algumas empresas definem que um cliente é considerado um cliente inadimplente quando ele está devendo acima de X
# reais e por mais de X dias. - Algumas empresas definem que um vendedor bateu a meta quando ele vendeu acima de X
# reais (outras ainda analisam não só as vendas desse vendedor, mas também da loja ou da unidade de negócios que ele
# faz parte, ou ainda uma avaliação qualitativa) - Algumas empresas definem que um produto está em "falta" no estoque
# quando ele está abaixo de um nível mínimo quando um cliente insere um novo pedido daquele produto - E assim vai
# para dezenas de indicadores.

# O ponto importante é, cada empresa tem alguma adaptação do cálculo de indicadores. E normalmente se formos analisar
# esses indicadores é interessante ter funções que façam todo o trabalho de análise deles. Por isso, vamos construir
#  2 exemplos aqui:
...
vendas = {'VE0001': (9868, 'Concluído', ''), 'VE0002': (9642, 'Concluído', ''), 'VE0003': (6007, 'Concluído', ''),
          ...
          'VE0163': (8456, 'Concluido', 'Cancelada pelo Cliente'), 'VE0164': (1291, 'Concluído', ''),
          ...
          'VE0180': (13337, 'Concluído', ''), 'VE0181': (457, 'Concluído', ''), 'VE0182': (17218, 'Concluído', ''),
